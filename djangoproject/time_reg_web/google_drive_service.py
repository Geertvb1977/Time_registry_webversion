...
class GoogleDriveService:
    ...
    def create_folder(self, name: str, parent_folder_id: str = None, share_with_members: bool = True) -> str:
        """
    ...
    def share_folder_with_company_members(self, folder_id: str, role: str = 'writer') -> None:
        ...
        for member in members:
            if member.email:
                self.share_file_with_user(
                    file_id=folder_id,
                    email_address=member.email,
                    role=role
                )
            else:
                logger.warning(f"Lid {member.username} heeft geen e-mailadres geconfigureerd. Kan map niet delen.")

    def create_empty_google_doc(self, title: str, file_type: str = 'document', parent_folder_id: str = None) -> str:
        """
    ...
    def upload_and_convert_file(self, django_file, title: str, original_mime_type: str, convert_to_google: bool = True, parent_folder_id: str = None) -> tuple:
        """
